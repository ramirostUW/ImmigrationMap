...
const MapChartUK = (props) => {
  ...
  const markers = [
    ...
    { xmarkerOffset : 0, markerOffset: -15, name: "Milton Keynes", coordinates: [-0.7594, 52.0406] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Bath", coordinates: [-2.3597, 51.3781] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Reading", coordinates: [-0.9787, 51.4551] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Aberdeen", coordinates: [-2.0938, 57.1499] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Cambridge", coordinates: [-0.1313, 52.1951] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Oxford", coordinates: [-1.2577, 51.7520] },
    ...
    { xmarkerOffset : 0, markerOffset: -15, name: "York", coordinates: [-1.0739, 53.9614] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Manchester", coordinates: [-2.2426, 53.4808] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Bristol", coordinates: [-2.5879, 51.4545] },
    { xmarkerOffset : 20, markerOffset: -5, name: "Brighton", coordinates: [-0.1363, 50.8229] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Coventry", coordinates: [-1.5090, 52.4128] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Leeds", coordinates: [-1.5491, 53.8008] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Norwich", coordinates: [-1.2979, 52.6293] },
    { xmarkerOffset : 0, markerOffset: 15, name: "Glasgow", coordinates: [-4.2518, 55.8642] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Nottingham", coordinates: [-1.1550, 52.9540] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Leicester", coordinates: [-1.1398, 52.6369] },
    { xmarkerOffset : -10, markerOffset: 15, name: "Exeter", coordinates: [-3.5275, 50.7260] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Birmingham", coordinates: [-1.8904, 52.4862] },
    { xmarkerOffset : -19, markerOffset: -5, name: "Southampton", coordinates: [-1.4049, 50.9105] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Sheffield", coordinates: [-1.4701, 53.3811] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Liverpool", coordinates: [-2.9916, 53.4084] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Cardiff", coordinates: [-3.1681, 51.4837] },
    { xmarkerOffset : 0, markerOffset: -5, name: "Newcastle", coordinates: [-1.6178, 54.9783] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Belfast", coordinates: [-5.9301, 54.5973] },
    { xmarkerOffset : 0, markerOffset: -15, name: "Derby", coordinates: [-1.4746, 52.9225] }
  ]
